...
class dilBilgisiIng extends StatefulWidget {
  const dilBilgisiIng({Key? key}) : super(key: key);

  @override
  State<dilBilgisiIng> createState() => _dilBilgisiIngState();
}

class _dilBilgisiIngState extends State<dilBilgisiIng> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: StreamBuilder<QuerySnapshot>(
        stream: db.collection('dilBilgisiIng').snapshots(),
