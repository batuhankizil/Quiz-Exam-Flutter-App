...
class anlamBilgisi extends StatefulWidget {
  const anlamBilgisi({Key? key}) : super(key: key);

  @override
  State<anlamBilgisi> createState() => _anlamBilgisiState();
}

class _anlamBilgisiState extends State<anlamBilgisi> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: StreamBuilder<QuerySnapshot>(
        stream: db.collection('anlamBilgisi').snapshots(),
