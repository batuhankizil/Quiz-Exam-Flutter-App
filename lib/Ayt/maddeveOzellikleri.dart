...
class maddeveOzellikleri extends StatefulWidget {
  const maddeveOzellikleri({Key? key}) : super(key: key);

  @override
  State<maddeveOzellikleri> createState() => _maddeveOzellikleriState();
}

class _maddeveOzellikleriState extends State<maddeveOzellikleri> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: StreamBuilder<QuerySnapshot>(
        stream: db.collection('maddeveOzellikleri').snapshots(),
