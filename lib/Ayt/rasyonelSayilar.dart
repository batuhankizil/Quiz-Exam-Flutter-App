...
class rasyonelSayilar extends StatefulWidget {
  const rasyonelSayilar({Key? key}) : super(key: key);

  @override
  State<rasyonelSayilar> createState() => _rasyonelSayilarState();
}

class _rasyonelSayilarState extends State<rasyonelSayilar> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: StreamBuilder<QuerySnapshot>(
        stream: db.collection('rasyonelSayilar').snapshots(),
