...
class isiSicaklikGenlesme extends StatefulWidget {
  const isiSicaklikGenlesme({Key? key}) : super(key: key);

  @override
  State<isiSicaklikGenlesme> createState() => _isiSicaklikGenlesmeState();
}

class _isiSicaklikGenlesmeState extends State<isiSicaklikGenlesme> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: StreamBuilder<QuerySnapshot>(
        stream: db.collection('isiSicaklikGenlesme').snapshots(),
