...
class kelimeBilgisi extends StatefulWidget {
  const kelimeBilgisi({Key? key}) : super(key: key);

  @override
  State<kelimeBilgisi> createState() => _kelimeBilgisiState();
}

class _kelimeBilgisiState extends State<kelimeBilgisi> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: StreamBuilder<QuerySnapshot>(
        stream: db.collection('kelimeBilgisi').snapshots(),
