...
class turkIslamDevletleri extends StatefulWidget {
  const turkIslamDevletleri({Key? key}) : super(key: key);

  @override
  State<turkIslamDevletleri> createState() => _turkIslamDevletleriState();
}

class _turkIslamDevletleriState extends State<turkIslamDevletleri> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: StreamBuilder<QuerySnapshot>(
        stream: db.collection('turkIslamDevletleri').snapshots(),
