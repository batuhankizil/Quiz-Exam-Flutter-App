...
class guzelSanatlar extends StatefulWidget {
  const guzelSanatlar({Key? key}) : super(key: key);

  @override
  State<guzelSanatlar> createState() => _guzelSanatlarState();
}

class _guzelSanatlarState extends State<guzelSanatlar> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: StreamBuilder<QuerySnapshot>(
        stream: db.collection('guzelSanatlar').snapshots(),
