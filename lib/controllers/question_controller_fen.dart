...
class QuestionControllerFen extends GetxController
  ...
  List<QuestionFen> _questions = sample_data_fen
      .map(
        (question) => QuestionFen(
            id: question['id'],
      ...
      .toList();
  List<QuestionFen> get questions => this._questions;
  ...
  void checkAns(QuestionFen QuestionFen, int selectedIndex) {
    // because once user press any option then it will run
    _isAnswered = true;
    _correctAns = QuestionFen.answer;
