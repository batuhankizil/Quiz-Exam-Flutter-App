...
class kureselIklim extends StatefulWidget {
  const kureselIklim({Key? key}) : super(key: key);

  @override
  State<kureselIklim> createState() => _kureselIklimState();
}

class _kureselIklimState extends State<kureselIklim> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: StreamBuilder<QuerySnapshot>(
        stream: db.collection('kureselIklim').snapshots(),
