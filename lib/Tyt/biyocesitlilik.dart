...
class biyocesitlilik extends StatefulWidget {
  const biyocesitlilik({Key? key}) : super(key: key);

  @override
  State<biyocesitlilik> createState() => _biyocesitlilikState();
}

class _biyocesitlilikState extends State<biyocesitlilik> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: StreamBuilder<QuerySnapshot>(
        stream: db.collection('biyocesitlilik').snapshots(),
