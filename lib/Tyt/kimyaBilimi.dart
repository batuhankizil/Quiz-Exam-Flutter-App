...
class kimyaBilimi extends StatefulWidget {
  const kimyaBilimi({Key? key}) : super(key: key);

  @override
  State<kimyaBilimi> createState() => _kimyaBilimiState();
}

class _kimyaBilimiState extends State<kimyaBilimi> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: StreamBuilder<QuerySnapshot>(
        stream: db.collection('kimyaBilimi').snapshots(),
