...
class kimyasalHesaplamalar extends StatefulWidget {
  const kimyasalHesaplamalar({Key? key}) : super(key: key);

  @override
  State<kimyasalHesaplamalar> createState() => _kimyasalHesaplamalarState();
}

class _kimyasalHesaplamalarState extends State<kimyasalHesaplamalar> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: StreamBuilder<QuerySnapshot>(
        stream: db.collection('kimyasalHesaplamalar').snapshots(),
