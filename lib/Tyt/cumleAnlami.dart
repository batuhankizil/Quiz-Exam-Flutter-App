...
class cumleAnlami extends StatefulWidget {
  const cumleAnlami({Key? key}) : super(key: key);

  @override
  State<cumleAnlami> createState() => _cumleAnlamiState();
}

class _cumleAnlamiState extends State<cumleAnlami> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: StreamBuilder<QuerySnapshot>(
        stream: db.collection('cumleAnlami').snapshots(),
