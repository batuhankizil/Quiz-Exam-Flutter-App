...
class deyimveAtasozu extends StatefulWidget {
  const deyimveAtasozu({Key? key}) : super(key: key);

  @override
  State<deyimveAtasozu> createState() => _deyimveAtasozuState();
}

class _deyimveAtasozuState extends State<deyimveAtasozu> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: StreamBuilder<QuerySnapshot>(
        stream: db.collection('deyimveAtasozu').snapshots(),
